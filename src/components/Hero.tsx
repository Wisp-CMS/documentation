...
const code = `import { wisp } from "../../wisp";
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Stop struggling with adding blog articles to your site
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                wisp is a headless CMS that makes it easy to add blog articles to your site. Learn to set up wisp on your site in 30 minutes or less.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="#documentation-content">Get started</Button>
                <Button href="https://wisp.blog/" variant="secondary">
                  Sign up for wisp
                </Button>
              </div>
            </div>
